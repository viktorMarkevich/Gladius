...
ActiveRecord::Schema.define(version: 20141105120928) do
  ...
  add_index "articles", ["admin_author_id"], name: "index_articles_on_admin_author_id", unique: true, using: :btree
